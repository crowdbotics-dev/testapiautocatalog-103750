...
## Project Structure
    ...
    ├── testapiautocatalog_103750  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_103750`
...
2. Clone this repo and `cd testapiautocatalog_103750`
